...
class TLSClientSession:
    def __init__(
        ...
        if early_data:
            ...
            print('early data:', self.packed_early_data)
    ...
    def unpack_handshake(self, mv: memoryview):
        ...
        if handshake_type == HandshakeType.server_hello:
            ...
            print('decrypted:', self.peer_cipher.verify_data(self.handshake_context))
    ...
    def tls_response(self):
        ...
        while True:
            ...
            print('hex:', head.hex(), content.hex())
            if head[0] == ContentType.alert:
                ...
                print('application data', self.peer_cipher.decrypt)
