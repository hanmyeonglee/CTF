...
class TLSClientSession:
    def __init__(
        ...
        print(self.private_key, self.key_exchange)
        self.early_data = early_data
        print(self.early_data)
        self.server_finished = False
        print(self.server_finished)
        self.session_tickets = []
        print(self.session_tickets)
        ...
        print(self.psk_identities)
        self.psk_label = psk_label
        print(self.psk_label)
        print('_client?')
    ...
    def _client(self):
        ...
        while not server_finished:
            ...
            print('fragment:', plain_text.fragment.hex())
            print('binary:', plain_text.binary[:5].hex())
        ...
        while True:
            ...
            if plain_text.content_type is models.ContentType.application_data:
                ...
                print('fragments:', models.Alert.parse(plain_text.fragment))
            else:
                print('content type:', plain_text.content_type)
